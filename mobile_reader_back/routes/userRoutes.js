...
router.post('/user/addNovel', checkAuth, async (req, res) => {
    ...
    const { novelTitle, numberOfChapters } = req.body;
    ...
    try {
        ...
        // Check if the novel already exists in the user's novels list
        ...
        if (!novelExists) {
            ...
            // Novel already exists, no need to add it again
